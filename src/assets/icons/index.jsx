const icons = {
	...
	attachUser: (props) => (
		...
		<g clip-path="url(#clip0_1753_241)">
		<path d="M20 1C9.42029 1 0 5.66899 0 21H40C39.9275 7.75958 30.5797 1 20 1Z" fill="#441F80"/>
		<path d="M39.2029 20H0C0 30.5797 9.42029 40 20 40C30.5797 40 40 30.5797 40 20H39.2029Z" fill="#553589"/>
		<path d="M19.4997 18.4168C21.8009 18.4168 23.6663 16.5513 23.6663 14.2502C23.6663 11.949 21.8009 10.0835 19.4997 10.0835C17.1985 10.0835 15.333 11.949 15.333 14.2502C15.333 16.5513 17.1985 18.4168 19.4997 18.4168Z" fill="white"/>
		<path fill-rule="evenodd" clip-rule="evenodd" d="M21.076 30.3827C21.6098 30.9167 22.4692 30.9167 24.1878 30.9167C25.9065 30.9167 26.7658 30.9167 27.2997 30.3827C27.8337 29.8489 27.8337 28.9895 27.8337 27.2708C27.8337 25.5522 27.8337 24.6928 27.2997 24.159C26.7658 23.625 25.9065 23.625 24.1878 23.625C22.4692 23.625 21.6098 23.625 21.076 24.159C20.542 24.6928 20.542 25.5522 20.542 27.2708C20.542 28.9895 20.542 29.8489 21.076 30.3827ZM23.1739 28.8089C22.4425 28.2852 21.5837 27.6701 21.5837 26.604C21.5837 25.427 23.016 24.5922 24.1878 25.7237C25.3597 24.5922 26.792 25.427 26.792 26.604C26.792 27.6701 25.9331 28.2852 25.2018 28.8089C25.1258 28.8632 25.0512 28.9167 24.9791 28.9696C24.7087 29.1676 24.4482 29.3542 24.1878 29.3542C23.9274 29.3542 23.667 29.1676 23.3966 28.9696C23.3245 28.9167 23.2498 28.8632 23.1739 28.8089Z" fill="white"/>
		<path d="M23.0567 22.07C22.0045 21.7334 20.7913 21.5415 19.4997 21.5415C15.4726 21.5415 12.208 23.407 12.208 25.7082C12.208 27.938 15.273 29.7586 19.1269 29.8695C19.0986 29.738 19.0768 29.6073 19.0596 29.4791C18.9786 28.8773 18.9787 28.142 18.9788 27.3603V27.1811C18.9787 26.3993 18.9786 25.664 19.0596 25.0622C19.1496 24.3925 19.3648 23.6595 19.9704 23.0539C20.5761 22.4483 21.309 22.2331 21.9787 22.143C22.3037 22.0993 22.6676 22.0792 23.0567 22.07Z" fill="white"/>
		</g>
		<defs>
		<clipPath id="clip0_1753_241">
